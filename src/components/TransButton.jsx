...
const TransButton = ({ color }) => {
  ...
  const textColorClass = color ? `text-${color}` : "text-pure-black";
  const svgFillColor = color === "white" ? "white" : "#2E344D";

  return (
    <Menu as="div" className="relative inline-block text-left">
      <Menu.Button
        className={`pt-1 px-1 flex items-center gap-2 ${textColorClass} hover:cursor-pointer`}
      >
        <svg
      ...
      <Menu.Items
        className={`absolute mt-2 w-48 origin-top-${
          isArabic ? "left" : "right"
